...
const translations = {
  id: {
    ...
    'sika.s3s2p': 'Menulis test script menggunakan Selenium WebDriver dengan bahasa pemrograman yang sesuai, mengikuti pola Page Object Model.',
  ...
  en: {
    ...
    'sika.s3s2': 'Script Writing',
    'sika.s3s2p': 'Writing test scripts using Selenium WebDriver with an appropriate programming language, following the Page Object Model pattern.',
    'sika.s3s3': 'Execution & Debug',
...
const projects = [
  ...
  },
  {
    ...
    desc_id: 'Membangun framework otomasi pengujian untuk platform akademik Sika Universitas. Mengotomatiskan test case kritis dengan Selenium WebDriver dan CI/CD integration.',
    desc_en: 'Building test automation framework for Sika Universitas academic platform. Automating critical test cases with Selenium WebDriver and CI/CD integration.',
