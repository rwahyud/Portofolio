...
const translations = {
  id: {
    ...
    'barberqa.metaRole': 'Peran',
    'barberqa.metaDate': 'Tanggal',
    'barberqa.metaDateVal': '2026',
    'barberqa.hero': 'Membangun framework otomasi pengujian untuk aplikasi Barber Black and White — platform manajemen barbershop berbasis web. Mengotomatiskan alur booking, manajemen pelanggan, dan transaksi untuk memastikan operasional barbershop berjalan lancar.',
    'barberqa.s1': 'Kenapa QA Automation?',
    'barberqa.s1p1': 'Barber Black and White adalah sistem yang dipakai untuk mengelola operasional barbershop sehari-hari — mulai dari booking jadwal, data pelanggan, sampai transaksi dan pembayaran. Kesalahan di sistem bisa mengganggu pelayanan pelanggan dan operasional bisnis.',
    'barberqa.s1p2': 'Gue membangun otomasi pengujian untuk memastikan semua alur kritis bekerja dengan benar. Dengan test yang berjalan otomatis, risiko bug saat fitur baru dirilis bisa diminimalisir dan kualitas aplikasi tetap terjaga.',
    'barberqa.s2': 'Automation Approach',
    'barberqa.s2c1': 'Booking Flow Testing',
    'barberqa.s2c1p': 'Mengotomatiskan alur booking — dari pemilihan layanan, pemilihan jadwal, sampai konfirmasi dan notifikasi ke pelanggan.',
    'barberqa.s2c2': 'Customer Management Verification',
    'barberqa.s2c2p': 'Test otomatis untuk memverifikasi CRUD data pelanggan, pencarian, dan histori kunjungan.',
    'barberqa.s2c3': 'Transaction & Payment Testing',
    'barberqa.s2c3p': 'Memastikan alur transaksi, perhitungan harga, dan pembayaran berjalan akurat dan sinkron.',
    'barberqa.s2c4': 'Regression Protection',
    'barberqa.s2c4p': 'Menjaga fitur yang sudah berjalan tidak rusak saat ada penambahan fitur baru lewat automated regression testing.',
    'barberqa.s3': 'Automation Workflow',
    'barberqa.s3s1': 'Test Analysis',
    'barberqa.s3s1p': 'Mengidentifikasi alur kritis yang paling berisiko dan berdampak besar jika terjadi bug.',
    'barberqa.s3s2': 'Script Writing',
    'barberqa.s3s2p': 'Menulis test script otomasi dengan Playwright untuk alur booking, pelanggan, dan transaksi.',
    'barberqa.s3s3': 'Execution & Debug',
    'barberqa.s3s3p': 'Menjalankan test suite, menganalisis kegagalan, dan memperbaiki flaky test agar hasilnya konsisten.',
    'barberqa.s3s4': 'Maintenance',
    'barberqa.s3s4p': 'Terus memperbarui test suite mengikuti perubahan fitur dan kebutuhan aplikasi.',
    'barberqa.s4': 'Tools & Technologies',
    'barberqa.s4p': 'Stack yang dipakai untuk membangun framework otomasi pengujian ini.',
    'barberqa.s5': 'Screenshot Hasil Automation',
    'barberqa.s5p': 'Screenshot dari hasil test report otomasi yang dijalankan pada aplikasi Barber Black and White.',
    'barberqa.s6': 'Impact & Results',
    'barberqa.s6p1': 'QA Automation memberikan dampak nyata pada kualitas dan keandalan aplikasi Barber Black and White.',
    'barberqa.s6p2': 'Dengan test otomatis, tim bisa merilis fitur baru dengan lebih percaya diri dan memastikan aplikasi siap dipakai tanpa bug yang mengganggu operasional barbershop.',
  ...
  en: {
    ...
    'barberqa.metaRole': 'Role',
    'barberqa.metaDate': 'Date',
    'barberqa.metaDateVal': '2026',
    'barberqa.hero': 'Building a test automation framework for Barber Black and White — a web-based barbershop management platform. Automating booking flows, customer management, and transactions to keep barbershop operations running smoothly.',
    'barberqa.s1': 'Why QA Automation?',
    'barberqa.s1p1': 'Barber Black and White is a system used daily to manage barbershop operations — from booking schedules, customer data, to transactions and payments. A system error can disrupt customer service and business operations.',
    'barberqa.s1p2': 'I built test automation to ensure all critical flows work correctly. With tests running automatically, the risk of bugs when releasing new features is minimized and app quality stays maintained.',
    'barberqa.s2': 'Automation Approach',
    'barberqa.s2c1': 'Booking Flow Testing',
    'barberqa.s2c1p': 'Automating the booking flow — from service selection, schedule selection, to confirmation and customer notification.',
    'barberqa.s2c2': 'Customer Management Verification',
    'barberqa.s2c2p': 'Automated tests to verify customer data CRUD, search, and visit history.',
    'barberqa.s2c3': 'Transaction & Payment Testing',
    'barberqa.s2c3p': 'Ensuring transaction flows, price calculations, and payments run accurately and stay in sync.',
    'barberqa.s2c4': 'Regression Protection',
    'barberqa.s2c4p': 'Keeping existing features from breaking when new features are added through automated regression testing.',
    'barberqa.s3': 'Automation Workflow',
    'barberqa.s3s1': 'Test Analysis',
    'barberqa.s3s1p': 'Identifying critical flows with the highest risk and biggest impact if a bug occurs.',
    'barberqa.s3s2': 'Script Writing',
    'barberqa.s3s2p': 'Writing automation test scripts with Playwright for booking, customer, and transaction flows.',
    'barberqa.s3s3': 'Execution & Debug',
    'barberqa.s3s3p': 'Running the test suite, analyzing failures, and fixing flaky tests for consistent results.',
    'barberqa.s3s4': 'Maintenance',
    'barberqa.s3s4p': 'Continuously updating the test suite following feature changes and app needs.',
    'barberqa.s4': 'Tools & Technologies',
    'barberqa.s4p': 'The stack used to build this automation testing framework.',
    'barberqa.s5': 'Automation Screenshots',
    'barberqa.s5p': 'Screenshots from the automation test report run on the Barber Black and White app.',
    'barberqa.s6': 'Impact & Results',
    'barberqa.s6p1': 'QA Automation has a tangible impact on the quality and reliability of the Barber Black and White app.',
    'barberqa.s6p2': 'With automated tests, the team can release new features with more confidence and ensure the app is ready without bugs disrupting barbershop operations.',
...
const projects = [
  ...
  {
    title: 'QA Automation Barber Black and White',
    subtitle: 'Barber Management',
    category: 'QA AUTOMATION',
    desc_id: 'Framework otomasi pengujian untuk aplikasi manajemen barbershop Barber Black and White. Mengotomatiskan alur booking, manajemen pelanggan, dan transaksi.',
    desc_en: 'Test automation framework for the Barber Black and White barbershop management app. Automating booking flows, customer management, and transactions.',
    tags: ['Playwright', 'Python', 'Pytest', 'CI/CD'],
    link: 'barber-qa.html',
    bg: 'barber',
    img: ''
